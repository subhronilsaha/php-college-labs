        ...
        <div class="content">
            ...
            <div class="middle"> 
                ...
                <div>
                    ...
                    <br>
                    <ul>
                        <li><a class = "module-selection-btn" href="user_modules/get_users.php">EMPLOYEE MODULE</a></li>
                        <li><a class = "module-selection-btn" href="course_modules/get_courses.php">DEPARTMENT MODULE</a></li>
                    </ul>
                </table>
                </div>
            </div>
